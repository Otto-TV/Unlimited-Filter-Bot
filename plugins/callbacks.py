...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Stream TV ‼️", url="https://t.me/StreamTVCommunity"),
                    InlineKeyboardButton("About Me 😎", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel 🤖", url="https://t.me/OPBots"),
                    InlineKeyboardButton("Support Group 🙆", url="https://t.me/RequestStreamTV")
                ]
            ]
        )
